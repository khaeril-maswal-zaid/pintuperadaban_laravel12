...
const blogPostSchema = z.object({
    title: z.string().min(5, 'Judul harus terdiri dari minimal 5 karakter').max(250, 'Judul tidak boleh lebih dari 250 karakter'),
...
export default function BlogPostModal() {
    ...
    const onSelectFile = (e: React.ChangeEvent<HTMLInputElement>, type: 'main' | 'sub1') => {
        ...
        reader.onload = () => {
            ...
            setImageType(type); // <-- Sekarang ini valid, karena parameternya ada!
        };
            ...
            <Dialog open={open} onOpenChange={handleOpenChange} modal={false}>
                ...
                >
                    <DialogHeader className="relative p-6 pb-2">
                        <DialogTitle>Buat Postingan Artikel Baru</DialogTitle>
                        <DialogDescription>
                            Isi detail di bawah ini untuk membuat postingan artikel baru. Klik Save Post ketika selesai.
                        </DialogDescription>

                        <Button
                            variant="ghost"
                            size="icon"
                            className="absolute top-4 right-4 rounded-sm p-0 opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-none disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground"
                                                                        ...
                                                                        <div className="relative h-full w-full">
                                                                            ...
                                                                            <div className="absolute top-1 right-1 flex gap-1">
                                                                                <Button
                                                                                    ...
                                                                                    onClick={(e) => {
                                                                                        e.stopPropagation();
                                                                                        setSrc(mainImage); // ← pasang base64 yg sudah di-crop
                                                                                        setImageType('main');
                                                                                        setCropDialogOpen(true);
                                                                                    }}
                                                                                >
